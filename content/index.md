...
- [Trussium runtime v1.18.0](https://github.com/trussiumhq/trussium/releases/tag/v1.18.0)
...
tool-execution surface, including the bounded `ping` handshake, is included in
the v1.18 release line and is documented
